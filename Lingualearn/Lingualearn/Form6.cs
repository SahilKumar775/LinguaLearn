...
namespace Se_iteration01
{
    public partial class Form6 : Form
    {
        ...
        private void rjButton1_Click(object sender, EventArgs e)
        {
            ...
            output.Text = translate(input.Text, from, to);
        }
        ...
        {
            TexttoSpeech.SelectVoiceByHints(VoiceGender.Female, VoiceAge.Adult, 1, new System.Globalization.CultureInfo(from));
            TexttoSpeech.SpeakAsync(input.Text);
        }

            private void button2_Click(object sender, EventArgs e)
        {
            TexttoSpeech.SelectVoiceByHints(VoiceGender.Female, VoiceAge.Adult, 1, new System.Globalization.CultureInfo(to));
            TexttoSpeech.SpeakAsync(output.Text);
        }
